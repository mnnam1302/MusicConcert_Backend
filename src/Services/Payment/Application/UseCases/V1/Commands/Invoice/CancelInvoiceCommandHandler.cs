...
public class CancelInvoiceCommandHandler : ICommandHandler<Command.CancelInvoiceCommand>
{
    ...
    public async Task<Result> Handle(Command.CancelInvoiceCommand request, CancellationToken cancellationToken)
    {
        /*
